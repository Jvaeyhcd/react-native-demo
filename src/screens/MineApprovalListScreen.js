...
export default class MineApprovalListScreen extends React.Component {
  ...
  render () {
    return (
      <ScrollableTabView
        ...
        />)}>
        <ScrollView tabLabel='未批示' style={styles.container} contentContainerStyle={styles.contentContainer}>
          <EventListItem onPress={() => this.props.navigation.navigate('EventDetail')}></EventListItem>
          <EventListItem onPress={() => this.props.navigation.navigate('EventDetail')}></EventListItem>
        </ScrollView>
        <ScrollView tabLabel='已批示' style={styles.container} contentContainerStyle={styles.contentContainer}>
          <EventListItem onPress={() => this.props.navigation.navigate('EventDetail')}></EventListItem>
        </ScrollView>
      </ScrollableTabView>
    )
